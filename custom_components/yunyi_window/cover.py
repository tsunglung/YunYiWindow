...
DEFAULT_NAME = 'YunYi Window'
DATA_KEY = 'cover.yunyi_window'
DOMAIN = "yunyi_window"
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    """Import YunYi Window configuration from YAML."""
    # pylint: disable=unused-argument
    _LOGGER.warning(
        "Loading YunYi Window via platform setup is deprecated; Please remove it from your configuration"
    )
...
async def async_setup_entry(hass, config, async_add_entities):
    """Set up the YunYi Window platform."""
...
class YunyiCover(CoverEntity):
    ...
    @property
    def is_closed(self):
        """Return the status of the cover."""
